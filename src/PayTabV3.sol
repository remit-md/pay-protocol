...
/// @title PayTabV3
/// @notice Pre-funded metered account with batch settlement and scheduled rectification.
/// @dev IMMUTABLE — no proxy, no admin key, no upgrade path. Holds USDC.
///
///      Changes from v2:
///        - withdrawCharged: onlyRelayer (was provider OR relayer). Provider calls closeTab to get funds.
///        - withdrawCharged: MIN_WITHDRAW_AMOUNT $0.10 (was MIN_DIRECT_AMOUNT $1.00).
///
///      State machine:
...
contract PayTabV3 is IPayTabV2, ReentrancyGuard {
    // =========================================================================
    ...
    /// @inheritdoc IPayTab
    /// @dev CHANGED from v2: onlyRelayer (was provider OR relayer).
    ///      Provider gets funds via closeTab or scheduled rectification.
